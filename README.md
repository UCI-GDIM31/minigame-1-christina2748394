...
# minigame-1
## Devlog
If we see scenes as chess boards, gameObjects will be the chess pieces on the board, and components will be the rule book that specifies the function of each chess piece.
## Open-Source Assets
